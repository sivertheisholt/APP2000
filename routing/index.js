...
router.use("/:currentLanguage", languageMiddleware.default_language, languageMiddleware.set_language, renderObjectMiddleware.renderObject, require('./indexRouter'));
